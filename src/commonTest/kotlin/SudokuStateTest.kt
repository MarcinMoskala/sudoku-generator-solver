...
class SudokuStateTest {
    ...
    @Test
    fun should_deserialize_solved_from_serialized() {
        val sudoku = generator.generateSolved()
        assertEquals(sudoku, SudokuState.from(sudoku.toString()))
    }

    @Test
    fun should_deserialize_unsolved_from_serialized() {
    ...
    @Test
    fun should_remove_value_and_include_this_value_as_possibility() {
    ...
    @Test
    fun should_remove_value_and_include_this_value_as_possibility_possibilities_in_line() {
        val sudokuState = SudokuState.from(
            """
